...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a2zaswv9p1wlxk-ats.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_ROOT_CA_FILENAME       "aws_iot_rootCA.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "aws_iot_cert.pem" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "aws_iot_privkey.pem" ///< Device private key filename
// =================================================
